...
def test_card_output():                 # type: ignore[no-untyped-def]
    assert number_output("Maestro 1596837868705199") == "1596837868705199"


def test_account_output():                 # type: ignore[no-untyped-def]
...
def test_date_in_correct_format(date, expected):               # type: ignore[no-untyped-def]
