...
def test_filter_by_currency(banking_information):         # type: ignore[no-untyped-def]
...
def test_transaction_descriptions(banking_information):          # type: ignore[no-untyped-def]
...
def test_card_numbers_generator() -> None:          # type: ignore[no-untyped-def]
