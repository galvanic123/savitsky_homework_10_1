...
from src.read_transactions import read_csv_transactions, read_xlsx_transactions
...
def main() -> None:
    ...
    while True:
        ...
        if item_number == "1":
            ...
            list_transactions = read_csv_transactions("C:/Users/Dell/PycharmProjects/savitsky_homework/data/transactions.csv")
            break
        elif item_number == "3":
            print("Для обработки выбран XLSX-файл.")
            list_transactions = read_xlsx_transactions("C:/Users/Dell/PycharmProjects/savitsky_homework/data/transactions_excel.xlsx")
            break
        else:
